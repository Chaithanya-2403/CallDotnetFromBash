...
dotnet_app_path="/home/chaithanya/Documents/DotnetFromBash/linux-x64/CallDotnetFromBash.dll"  # Update this to the actual path of your .NET DLL

# Directory to search for .txt files
directory_to_search="/home/chaithanya/Documents/DotnetFromBash/Bash"  # Update this to the directory where you want to search
